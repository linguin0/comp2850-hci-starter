...
### Test: Validation error
- **Action**: Deleted title, clicked "Save"
- **Result**: ✅ Error shown to fill out field
...
- **NVDA said**: "Alert: please fill out this field"
- **Result**: ✅ Error announced immediately (assertive) HOWEVER this is not what the original test wanted.
- **Error**:  X 
