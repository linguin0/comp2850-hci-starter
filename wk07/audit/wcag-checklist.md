...
| 2.4.4 Link Purpose | A | ⚠️ Partial | 'about' link in footer had no text attribute `<a href="/about"></a>`                        | Add text to that link |
...
- **Partial**: 3 (2.4.4 Link Purpose, 2.4.7 Focus Visible, 4.1.2 Name, Role, Value)
- **N/A**: 0
